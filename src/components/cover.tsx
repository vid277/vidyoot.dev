  ...
  return (
    <div className="h-[100vh] bg-neutral-900 flex flex-col items-center justify-center relative w-full font-oddolini">
      <div className="flex flex-col items-center justify-center gap-8">
        <h2 className="relative flex-col text-8xl md:text-[10rem] leading-tight max-w-8xl mx-auto text-center md:text-center tracking-tight font-medium bg-clip-text text-transparent bg-gradient-to-b from-neutral-400 via-white to-white flex items-center md:items-center gap-12 md:gap-8 z-[999] px-4 md:px-0">
