          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                >
                  <svg
                    className="w-4 h-4 sm:w-5 sm:h-5 text-gray-700 hover:text-black transition-colors"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 hover:text-[#005885] transition-colors"
                  title="LinkedIn"
                >
                  <svg
                    className="w-4 h-4 sm:w-5 sm:h-5 text-[#0077B5] hover:text-[#005885] transition-colors"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                >
                  <svg
                    className="w-4 h-4 sm:w-5 sm:h-5 text-[#EA4335] hover:text-[#D32F2F] transition-colors"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
            ...
            {enableTerminalInput && (
              <>
                <div className="flex-shrink-0">
                  <div className="font-mono text-xs sm:text-sm space-y-1 max-h-16 sm:max-h-24 overflow-y-auto">
                ...
                <div
                  className={`flex-shrink-0 flex items-center font-mono text-xs sm:text-sm border-t-2 border-black pt-3 sm:pt-4 ${
                    isClient && isMobile
                      ? "bg-gray-200 rounded-lg px-2 py-2 cursor-pointer active:bg-gray-300"
                      : ""
                  }`}
                  onClick={() => {
                    if (inputRef.current) {
