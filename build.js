...
// HTML template that matches index.html styling
function htmlTemplate({ title, content, isListing = false, description = '' }) {
  const pageTitle = isListing ? 'Blog — Vidyoot Senthil' : `${title} — Vidyoot Senthil`;
  const metaDescription = description || 'Blog posts by Vidyoot Senthil';
  ...
  <div class="container">
    ...
    <footer>
      <div class="social-links">
        <a href="mailto:vidyoots@gmail.com" title="Email">
        ...
        <a href="https://github.com/vid277" target="_blank" rel="noopener" title="GitHub">
        ...
        <a href="https://x.com/vidyoots" target="_blank" rel="noopener" title="X">
          <svg fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
        </a>
        <a href="https://linkedin.com/in/vidyootsenthil" target="_blank" rel="noopener" title="LinkedIn">
...
async function getAllPosts() {
  ...
  const posts = await Promise.all(
    files.map(f => readPost(path.join(CONTENT_DIR, f)))
  );
...
function generateListingPage(posts) {
  ...
  return htmlTemplate({
    ...
    content,
    isListing: true,
    description: 'Blog posts by Vidyoot Senthil on software engineering, AI, and more.'
  });
}
